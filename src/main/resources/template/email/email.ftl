...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="http://www.zonysoft.com" target="_blank">CNOOC_SYSTEM</a> 制度管理系统 All Rights Reserved.
        </div>
