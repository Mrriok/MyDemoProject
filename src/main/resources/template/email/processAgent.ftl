...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <p style="margin-bottom: 10px;padding-bottom: 0px;">您好：</p>
        <!-- drafterName：流程拟稿/提交人姓名，未定字段，后续自行修改 -->
        <!-- processTitle：流程标题，未定字段，后续自行修改 -->
        <p style="text-indent: 2em; margin-bottom: 10px;">${drafterName}给您发送了一项名为：《${processTitle}》的 ${workflowTypeName} 待办事项，请您登录 中国海洋石油有限公司制度管理系统 进行处理。</p>
        <p style="
			text-align: center;
