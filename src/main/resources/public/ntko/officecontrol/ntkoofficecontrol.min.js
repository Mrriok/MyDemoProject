...
var width = "100%";
//买断授权密钥如果不是买断可以不用写
var MakerCaption = "上海仲尼软件有限公司";
//买断授权密钥如果不是买断可以不用写
var MakerKey = "C94AE879207E4FAA14CE16CF55D811142015701D";
//密钥
var ProductCaption = "  ";
//密钥
var ProductKey = "97BFB9EF1BAC1ADAEB0F59D67224FCD3171F32DC";
//解除时间限制密钥
var NoExpireKey = "";
...
function OnSheetBeforeRightClick() {
...
function OnPPTBeforeRightClick() {
...
if (browser == "IE") {
    if (window.navigator.platform == "Win32") {
        ...
        object.setAttribute("id", "TANGER_OCX");
        object.setAttribute("classid", "clsid:" + classid);
        object.setAttribute("codebase", codebase);
        object.setAttribute("width", width);
        object.setAttribute("height", height);

        object.innerHTML = '<param name="MakerCaption" value="' + MakerCaption + '"></param>' +
            '<param name="MakerKey" value="' + MakerKey + '"></param>  ' +
            '<param name="ProductCaption" value="' + ProductCaption + '"></param>   ' +
            '<param name="ProductKey" value="' + ProductKey + '"></param>   ' +
            '<param name="NoExpireKey" value="' + NoExpireKey + '"></param>   ' +
            '<param name="IsUseUTF8URL" value="-1"></param>  ' +
            '<param name="IsUseUTF8Data" value="-1"></param>   ' +
    ...
    if (window.navigator.platform == "Win64") {
        var object = document.createElement("object");
        object.setAttribute("id", "TANGER_OCX");
        object.setAttribute("classid", "clsid:" + classidx64);
        object.setAttribute("codebase", codebase64);
        object.setAttribute("width", width);
        object.setAttribute("height", height);
    ...
    object.setAttribute("id", "TANGER_OCX");
    object.setAttribute("classid", "clsid:" + classid);
    object.setAttribute("ForOnSaveToURL", "ntkosavetourl");
    object.setAttribute("ForOndocumentopened", "ntkoondocumentopened");
    object.setAttribute("ForOnpublishAshtmltourl", "ntkopublishashtml");
    object.setAttribute("ForOnpublishAspdftourl", "ntkopublishaspdf");
    object.setAttribute("ForOnSaveAsOtherFormatToUrl", "ntkosaveasotherurl");
    object.setAttribute("_IsUseUTF8URL", "-1");
    object.setAttribute("_IsUseUTF8Data", "-1");
    object.setAttribute("_MakerCaption", MakerCaption);
    object.setAttribute("_MakerKey", MakerKey);
    object.setAttribute("_ProductCaption", ProductCaption);
    object.setAttribute("_NoExpireKey", NoExpireKey);
    object.setAttribute("_ProductKey", ProductKey);
    object.setAttribute("codebase", codebase);
    object.setAttribute("width", width);
    object.setAttribute("height", height);
    object.setAttribute("type", "application/ntko-plug");

    object.innerHTML = '<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件</SPAN>    '
    mainContent.appendChild(object)
} else if (Sys.opera) {
