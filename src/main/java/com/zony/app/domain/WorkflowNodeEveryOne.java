...
@Getter
@Setter
@Table(name = "app_workflow_node_every_one")
public class WorkflowNodeEveryOne extends BaseEntity implements Serializable {
    @Id
    @Column(name = "workflow_node_every_one_id")
