...
import com.zony.app.repository.MenuRepository;
...
import com.zony.app.domain.vo.MenuMetaVo;
import com.zony.app.domain.vo.MenuVo;
...
public class MenuService {
    ...
    public List<MenuDto> findByUser(String currentUserName) {
        List<RoleSmallDto> roles = roleService.findByUsersName(currentUserName);
    ...
    public void delCaches(Long id, Long oldPid, Long newPid){
        ...
        redisUtils.delByKeys("menu::user:",users.stream().map(User::getUserId).collect(Collectors.toSet()));
