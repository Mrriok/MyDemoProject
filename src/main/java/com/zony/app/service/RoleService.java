...
import com.zony.app.repository.RoleRepository;
import com.zony.app.repository.UserRepository;
import com.zony.app.service.mapstruct.RoleMapper;
import com.zony.app.service.mapstruct.RoleSmallMapper;
...
import com.zony.app.service.criteria.RoleQueryCriteria;
...
public class RoleService {
    ...
    public List<RoleSmallDto> findByUsersName(String username) {
        return roleSmallMapper.toDto(new ArrayList<>(roleRepository.findByUsername(username)));
    }
    ...
    public List<GrantedAuthority> mapToGrantedAuthorities(UserDto user) {
        ...
        Set<Role> roles = roleRepository.findByUsername(user.getUsername());
