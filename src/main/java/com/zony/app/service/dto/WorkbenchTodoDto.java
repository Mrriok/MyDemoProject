...
@Data
@Entity
public class WorkbenchTodoDto extends BaseDTO implements Serializable {
    @Id
    private Long id;
    ...
    public WorkbenchTodoDto() {
    }

    public WorkbenchTodoDto(Long id, WorkflowClassEnum workflowType, String workflowNum, String workflowTitle, Integer nowStepNum, String startUsername, Boolean finishFlag, Date createDate, String stepName, Integer stepSeqNum, String disposeObjId, WorkflowDisposeObjEnum disposeObjType, WorkflowDisposeWayEnum disposeWayType, String organizerName) {
        this.id = id;
